...
public class MessageSender {
    ...
    private String getAccessToken() {
        try {
            ...
            Logger.getLogger(MessageSender.class).log(Level.SEVERE, "Failed refreshing Google Auth2.0 token",e);
        }
    ...
    public MessageSender(InputStream config_stream, String project_name) {
        try {
            ...
            e.printStackTrace();
            Logger.getLogger(MessageSender.class).log(Level.SEVERE, "Failed building GoogleCredential ",e);
        }
